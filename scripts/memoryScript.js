...
// le counter est égale à 14 si le joueur a gagné car il y a 14 paires
if(counter==14){
// Calcul du score (2 minutes - le temps restant)
var temps = 120-total_secondes;

    //Fonction ajax permettant de transmettre le score au PHP coté serveur
    $.ajax({
